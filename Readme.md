...
<h1 align="center">Hotel Booking Web App</h1>
  <p align="center">
    ...
    .
    <a href="https://github.com/satyendratiwri/Hotel-management-system/issues">Report Bug</a>
    ·
    <a href="https://github.com/satyendratiwri/Hotel-management-system/issues">Request Feature</a>
  </p>
</p>
...
1. Clone the repo
   ```sh
   git clone https://github.com/satyendratiwri/Hotel-management-system.git
   ```
...
See the [open issues](https://github.com/satyendratiwri/Hotel-Management-System/issues) for a list of proposed features (and known issues).
